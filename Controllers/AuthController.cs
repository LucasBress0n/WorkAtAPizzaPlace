...
namespace WorkAtAPizzaPlace.Controllers;
...
{
    private WorkAtAPizzaPlaceDbContext _dbContext;
    private UserManager<IdentityUser> _userManager;

    public AuthController(WorkAtAPizzaPlaceDbContext context, UserManager<IdentityUser> userManager)
    {
        _dbContext = context;
